...
-->
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <section style="background-image: url('img/black_2_quado.jpg')" class="tm-section tm-section-home tm-flex-center" id="home">
            ...
            <!-- Section 2 -->
            <section style="background-image: url('img/quadro_snow.jpg')" class="tm-section tm-section-about" id="about">
            ...
            <!-- Section 3 -->
            <section style="background-image: url('img/quadro_sun.jpg')" class="tm-section tm-section-services" id="services">
